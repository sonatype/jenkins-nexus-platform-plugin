...
class IqPolicyEvaluatorUtil
{
                                                    ...
                                                    final TaskListener listener)
  {
    try {
      ...
      checkArgument(verified, 'Argument iqApplication ' + applicationId + ' is invalid.')
      ...
      def proprietaryConfig =
          rethrowNetworkErrors {
            iqClient.getProprietaryConfigForApplicationEvaluation(applicationId)
          }
      ...
      def evaluationResult = rethrowNetworkErrors {
        iqClient.evaluateApplication(applicationId, iqPolicyEvaluator.iqStage, scanResult)
      }
